      ...
      <section className="flex items-center justify-between lg:flex-col lg:space-y-6">
        ...
        <section className="flex items-center space-x-4">
          {footerTexts.socials.map((social) => (
            <section key={social.name} className={`w-12 h-12 flex items-center justify-center hover:bg-white rounded-xl lg:h-10 lg:w-10 ${social.name === "facebook" ? "bg-indigo-500 hover:bg-indigo-700" : "bg-neutral-100 hover:bg-indigo-700"}`}>
