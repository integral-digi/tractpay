      ...
      <section className="flex items-center justify-between lg:flex-col lg:space-y-6">
        ...
        <section className="flex items-center space-x-4">
          {footerTexts.socials.map((social) => (
            <section key={social.name} className={`w-12 h-12 flex items-center justify-center hover:bg-indigo-700 rounded-xl lg:h-10 lg:w-10 ${social.name === "facebook" ? "bg-indigo-500 " : "bg-neutral-100"}`}>
